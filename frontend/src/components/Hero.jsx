      ...
      <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="mt-8 text-gray-400 text-lg leading-8 max-w-xl">
            Discuss your favorite topics, share insights,
            discover new communities, and connect with people
            who share your interests.
          </p>

          <button className="mt-10 px-8 py-4 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 text-white font-semibold flex items-center gap-3 hover:scale-105 duration-300 shadow-lg shadow-purple-600/40">
            Create Thread
            <FiArrowRight />
          </button>
        </div>
        ...
        <div className="flex justify-center">
          <div className="relative group">
            ...
            <div className="relative w-[480px] h-[220px] rounded-[40px] bg-[#151026] border border-purple-500/20 flex items-center justify-center overflow-hidden">
              ...
              {/* Decorative Circle */}
              <div className="absolute top-6 right-6 w-20 h-20 border border-cyan-400/30 rounded-full"></div>
