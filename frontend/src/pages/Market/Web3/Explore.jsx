...
import { FiZap, FiExternalLink, FiStar } from 'react-icons/fi';
import { FaWallet } from "react-icons/fa";

const Explore = () => {
    
    const web3Projects = [
        { name: "Decentraland", symbol: "MANA", desc: "Virtual reality platform", price: "0.42", change: "+4.2%", color: "from-purple-500 to-pink-500" },
        { name: "The Sandbox", symbol: "SAND", desc: "User-generated metaverse", price: "0.38", change: "-1.8%", color: "from-orange-500 to-red-500" },
        { name: "Axie Infinity", symbol: "AXS", desc: "Play-to-Earn Gaming", price: "6.85", change: "+12.4%", color: "from-cyan-500 to-blue-500" },
        { name: "Render Network", symbol: "RNDR", desc: "GPU rendering on blockchain", price: "8.92", change: "+7.1%", color: "from-emerald-500 to-teal-500" },
    ];
                ...
                <div className="bg-[#1A1633] rounded-3xl p-8 border border-gray-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {web3Projects.map((project, index) => (
                            <div key={index} className="group bg-[#252040] hover:bg-[#2A2450] p-6 rounded-2xl transition-all duration-300 border border-transparent hover:border-purple-500/50 cursor-pointer">
